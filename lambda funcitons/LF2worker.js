var TASK_QUEUE_URL = 'https://sqs.us-east-1.amazonaws.com/XXXXXXXXXXXX/diningSuggestions';
...
function invokeWorkerLambda(task, callback) {
  var params = {
    FunctionName: "arn:aws:lambda:us-east-1:XXXXXXXXXXXX:function:CallYelpAPI",
